...
import { Box, ButtonGroup, Button, FormControl, FormControlLabel, FormLabel, Radio, RadioGroup } from '@mui/material';
...
function App() {
  ...
  const [bangaloreWeather, setBengaluruWeather] = useState<WeatherReport>();
    ...
    <div className='d-flex justify-content-center align-items-center flex-column gap-5' style={{ width: "100%" }}>
      <Box display="flex" justifyContent="center">
        <ButtonGroup>
          ...
          <Button
            onClick={() => bangaloreWeather && handleCityClick('Bengaluru', bangaloreWeather)}
